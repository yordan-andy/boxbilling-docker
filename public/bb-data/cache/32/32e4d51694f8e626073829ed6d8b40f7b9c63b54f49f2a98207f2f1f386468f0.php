...
class __TwigTemplate_900f60ae4d62051caccfcfb3415b9dd9534640c67cc1b86de9a28d0abb5af222 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["guest"] ?? null), "extension_is_on", [0 => ["mod" => "cookieconsent"]], "method", false, false, false, 29)) {
            ...
            try {
                $__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4 =                 $this->loadTemplate("mod_cookieconsent_index.phtml", "layout_default.phtml", 30);
            } catch (LoaderError $e) {
...
";
        ...
        try {
            $__internal_62824350bc4502ee19dbc2e99fc6bdd3bd90e7d8dd6e72f42c35efd048542144 =             $this->loadTemplate("partial_pending_messages.phtml", "layout_default.phtml", 226);
        } catch (LoaderError $e) {
            // ignore missing template
        }
